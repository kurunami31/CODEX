...
if ('serviceWorker' in navigator && import.meta.env.PROD) {
  ...
  // Desktop tabs often sit open in the background for days — no navigation,
  // no reload, so the update check never runs and the page keeps rendering
  // the deployment from when the tab was opened. Force a check every time
  // the user actually looks at the tab again.
